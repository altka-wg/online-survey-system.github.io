...
<div class="col-lg-12">
	<div class="d-flex w-100 justify-content-center align-items-center mb-2">
		<label for="" class="control-label">Судалгааг олох</label>
	...
	<div class=" w-100" id='ns' style="display: none"><center><b>Хайлт илэрцгүй</b></center></div>
	<div class="row">
		<?php 
		$survey = $conn->query("SELECT * FROM survey_set order by date_created desc");
              ...
              <div class="card-body" style="display: block;">
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
					<a href="index.php?page=view_survey_report&id=<?=$row['id'] ?>" class="btn btn-sm bg-gradient-primary"><i class="fa fa-poll"></i> Үзэх</a>
               	</div>
               </div>
              </div>
            </div>
